...
BX.CMenu.prototype.addItem = function(item, index)
{
	...
	else
	{
		...
		if (!!item.ONCLICK)
		{
			...
			BX.bind(item.NODE, 'click', BX.defer(item.ONCLICK));
		}
	}
...
BX.adminInformer = {
	...
	Toggle: function(notifyBlock)
	{
		...
		informer.style.top = (parseInt(pos.top)+parseInt(pos.height)+5)+'px';
	...
	ShowAll: function()
	{
		...
		BX.unbind(footerLink, "click", BX.proxy(BX.adminInformer.ShowAll, footerLink));
		BX.bind(footerLink, "click", BX.proxy(BX.adminInformer.HideExtra, footerLink));
	...
	HideExtra: function()
	{
		...
		if(footerLink.textContent !== undefined)
			footerLink.textContent = BX.message('JSADM_AI_ALL_NOTIF');
		else
			footerLink.innerText = BX.message('JSADM_AI_ALL_NOTIF');

		BX.unbind(footerLink, "click", BX.proxy(BX.adminInformer.HideExtra, footerLink));
		BX.bind(footerLink, "click", BX.proxy(BX.adminInformer.ShowAll, footerLink));
