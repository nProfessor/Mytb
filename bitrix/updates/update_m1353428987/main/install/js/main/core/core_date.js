...
BX.CalendarPeriod =
{
	...
	OnChangeP: function(sel)
	{
		...
		inputFromWrap.style.display = (bShowFrom? '':'none');
		inputToWrap.style.display = (bShowTo? '':'none');
		selDirectWrap.style.display = (bShowDirect? '':'none');
		separator.style.display = (bShowSeparate? '':'none');
	},
