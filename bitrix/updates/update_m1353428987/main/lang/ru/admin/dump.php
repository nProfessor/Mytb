...
$MESS["MAIN_DUMP_INTEGRITY_CHECK"] = "Проверка целостности архива";
$MESS["MAIN_DUMP_ENC_ERR_CYR"] = "Во избежание проблем с распаковкой архива кириллические символы в пароле не допускаются ";
$MESS["MAIN_DUMP_CYR_LETTERS"] = "а-яА-Я";
$MESS["MAIN_DUMP_ENC_PASS_DESC"] = "Пароль для шифрования архива должен быть не менее 6 символов";
$MESS["MAIN_DUMP_EMPTY_PASS"] = "Не задан пароль для шифрования архива";
$MESS["MAIN_DUMP_SECURITY"] = "Безопасность";
$MESS["MAIN_DUMP_NOT_INSTALLED"] = "Не установлен PHP модуль Mcrypt";
$MESS["MAIN_DUMP_NO_ENC_FUNCTIONS"] = "Функции шифрования не доступны. Обратитесь к системному администратору для решения проблемы";
...
$MESS["MAIN_DUMP_SAVE_PASS"] = "Запишите пароль в надежном месте, без знания этого пароля восстановить резервную копию не удастся.";
...
$MESS["DUMP_MAIN_BITRIX_CLOUD"] = "Облака \"1С-Битрикс\"";
...
$MESS["DUMP_MAIN_ACTIVATION"] = "Активация";
$MESS["DUMP_MAIN_ACTIVATION_INFO"] = "Для каждой лицензии с активным периодом получения обновлений бесплатно предоставляется место в облачном хранилище \"1С-Битрикс\" для резервных копий. Доступ к резервным копиям осуществляется по лицензионному ключу и паролю. Без знания этого пароля никто, включая сотрудников 1С-Битрикс, не сможет получить доступ к вашим данным. Запишите пароль в надёжном месте, если вы забудете пароль, мы не сможем его восстановить.";
$MESS["DUMP_MAIN_LICENSE_KEY"] = "Лицензионный ключ:";
$MESS["DUMP_MAIN_CHANGE"] = "изменить";
$MESS["DUMP_MAIN_KEY_INFO"] = "информация о ключе";
$MESS["DUMP_MAIN_PASSWORD_CLOUD"] = "Пароль доступа к резервным копиям:";
$MESS["DUMP_MAIN_PASSWORD_CONFIRM"] = "Повтор пароля:";
$MESS["DUMP_MAIN_AGREE"] = "Согласен с <a href='http://www.1c-bitrix.ru' target=_blank>правилами предоставления услуги</a>";
$MESS["DUMP_MAIN_ACT_BUTTON"] = "Активировать";
$MESS["DUMP_MAIN_SAVE_TO_THE_CLOUD"] = "Сохранение бэкапа в облачное хранилище 1С-Битрикс";
$MESS["DUMP_MAIN_DISK_SPACE"] = "Дисковое пространство:";
$MESS["DUMP_MAIN_USED"] = "использовано ";
$MESS["DUMP_MAIN_FROM"] = "из ";
$MESS["DUMP_MAIN_GB"] = "Гб";
$MESS["DUMP_MAIN_SAVE_TO_1CBITRIX"] = "Сохранить резервную копию в облако &quot;1С-Битрикс&quot;:";
$MESS["DUMP_MAIN_PASSWORD_FLD"] = "Пароль:";
$MESS["DUMP_MAIN_USED_PASS"] = "Укажите пароль, который использовался для активации облачного хранилища, этим паролем будет зашифрован архив.";
?>