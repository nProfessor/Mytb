...
?>
	<tr>
		<td valign="top" width="50%"><?echo GetMessage("MAIN_OPTION_LICENSE_KEY")?></td>
		<td valign="middle" width="50%"><input type="text" size="30" maxlength="40" value="<?echo ($USER->CanDoOperation('edit_other_settings') ? htmlspecialcharsbx($SET_LICENSE_KEY) : "XXX-XX-XXXXXXXXXXXXX")?>" name="SET_LICENSE_KEY">
		</td>
	</tr>
