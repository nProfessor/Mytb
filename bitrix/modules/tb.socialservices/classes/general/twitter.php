...
class TrCSocServTwitter extends TrCSocServAuth
{
	const ID = "Twitter";
	...
	public function GetFormHtml($arParams)
	{
		...
		if($arParams['NO_TEXT'] == 'Y'){
			return '<a href="javascript:void(0)" onclick="BX.util.popup(\''.htmlspecialchars(CUtil::JSEscape("/auth?auth_service_id=".self::ID)).'\', 800, 450)" class="bx-ss-button twitter-button"></a>';
		}else{
			return '<a href="javascript:void(0)" onclick="BX.util.popup(\''.htmlspecialchars(CUtil::JSEscape("/auth?auth_service_id=".self::ID)).'\', 800, 450)" class="bx-ss-button twitter-button"></a><span class="bx-spacer"></span><span>'.GetMessage("socserv_tw_note").'</span>';
		}
