...
$MESS ['PAGER_DESC_SUMMING_TIP'] = "Механизм используют, если при добавлении элемента инфоблока он попадает наверх списка. Таким образом меняется лишь последняя страница. Все предыдущие можно надолго закешировать.";
$MESS ['PAGER_DESC_SUMMING_CACHE_TIME_TIP'] = "Указывается время кеширования страниц для обратной навигации в секундах.";
