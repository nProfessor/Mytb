...
<div class="club_info">
    <div class="m_left w2  options">
        ...
        <div>Обновление: <br/><?=$clubInfo['TIMESTAMP_X']?></div><br/>
    ...
    <div class="m_left w4 options">
        <div style="padding-left:30px">
            ...
            <dl>
                ...
                <dd>
                    <meta itemprop="openingHours"
                          content="<?$clubInfo["PROPERTY_TIME_WORKING_VALUE"]?>"><?=str_replace(array(",", ";"), "<br>", $clubInfo["PROPERTY_TIME_WORKING_VALUE"]);?>
                </dd>
            </dl>
            <? endif;?>
            ...
            <dl>
                <dt>Цена коктейля</dt>
                <dd itemprop="priceRange"><?=$clubInfo["PROPERTY_PRICE_COCKTAIL_VALUE"];?></dd>
            </dl>
            <? endif;?>
            ...
            <dl>
                <dt>Сайт</dt>
                <dd itemprop="url"><?=str_replace("http://", "", $clubInfo["~PROPERTY_SITE_VALUE"]);?></dd>
            </dl>
...
<div>
    <ul class="w10 menu_club">
        <li><a href="#stock" data-block="stock" id="a_stock" itemprop="url">Акции</a></li>
        <li><a href="#event" data-block="event" id="a_event" itemprop="url">События</a></li>
        <li><a href="#news" data-block="news" id="a_news" itemprop="url">Новости</a></li>
        <li><a href="#map" data-block="map" id="a_map" itemprop="url">Схема проезда</a></li>
        <li><a href="#descr" data-block="descr" id="a_descr" itemprop="url">Описание</a></li>
        <li><a href="#photo" data-block="photo" id="a_photo" itemprop="url">Фото/видео</a></li>
        <li><a href="#reviews" data-block="reviews" id="a_reviews" itemprop="url">Отзывы</a></li>
    </ul>
    <div class="clear_both"></div>
</div>
<div class="block_info" id="b_descr" itemprop="description">
