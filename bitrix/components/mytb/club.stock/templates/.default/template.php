...
Для покупки купона на скидку и получения полной информации об акции необходимо <strong><span data-link='<?=$arResult['stockInfo']['PROPERTY_URL_VALUE']?>'>перейти на сайт партнера <?=$partner['site']?></span></strong>
    </div>
