...
if (isset($_POST['save'])) {
    ...
    if (count($_POST['news']))
        foreach ($_POST['news'] as $var) {
            $var                     = intval($var);
            $clubSave["LINK_NEWS"][] = $var;
        }
...
$arListClubSubsNEWS  = $rs['PROPERTY_LINK_NEWS_VALUE'];


$clubAll = array_merge((array)$arListClubSubsEVENT, (array)$arListClubSubsSTOK, (array)$arListClubSubsNEWS);
...
$arResult['SUBS']["NEWS"]  = $arListClubSubsNEWS;
