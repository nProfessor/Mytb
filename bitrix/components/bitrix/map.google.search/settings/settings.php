	...
	<div class="bx-google-map-controls-group">
		<b><?echo GetMessage('MYMV_SET_START_POS')?></b><br />
			<ul id="bx_google_position">
				<li><?echo GetMessage('MYMV_SET_START_POS_LAT')?>: <span class="bx-google-map-controls-value" id="bx_google_lat_value"></span><input type="hidden" name="bx_google_lat" value="<?echo htmlspecialchars($arData['google_lat'])?>" /></li>
				<li><?echo GetMessage('MYMV_SET_START_POS_LON')?>: <span class="bx-google-map-controls-value" id="bx_google_lon_value"></span><input type="hidden" name="bx_google_lon" value="<?echo htmlspecialchars($arData['google_lon'])?>" /></li>
				<li><?echo GetMessage('MYMV_SET_START_POS_SCALE')?>: <span class="bx-google-map-controls-value" id="bx_google_scale_value"></span><input type="hidden" name="bx_google_scale" value="<?echo htmlspecialchars($arData['google_scale'])?>" /></li>
