 ...
 */
    ...
    class QRimage {
        ...
        //----------------------------------------------------------------------
        public static function png($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4,$saveandprint=FALSE, $QR_COLOR, $QR_COLORBG)
        {

            $image = self::image($frame, $pixelPerPoint, $outerFrame, $QR_COLOR, $QR_COLORBG);
