			...
			<tbody><tr>
				<td style="width: 100%;">
                    <div class="input-append">
                        <input class="span7" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" /><button class="btn" type="submit"><?echo GetMessage("CT_BSP_GO")?>!</button>
                    </div>
				...
				<div id="search_params" class="search-filter" style="display:<?echo $arResult["REQUEST"]["FROM"] || $arResult["REQUEST"]["TO"] || $arResult["REQUEST"]["WHERE"]? 'block': 'none'?>">
					...
					<table class="search-filter" cellspacing="0"><tbody>
						...
						<tr>
							...
							<td class="search-filter-field"><input class="search-button btn" value="<?echo GetMessage("CT_BSP_GO")?>" type="submit"></td>
						</tr>
					</tbody></table>
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		...
		<?foreach($arResult["SEARCH"] as $arItem):?>
			<div class="search-item">
				...
				<div class="search-preview"><?echo substr($arItem["~BODY"],0,300)?></div>
				<?if(
